...
function ImgEditList() {
    ...
    const { imageSrc, filterStyle, CroppedSrc, brightness, setBrightness, contrast, setContrast, saturate, setSaturate } = useContext(TravisContext)
    ...
    return (
        <MyLayoutHeader>
            <div className="d-flex flex-column align-items-center px-5" style={{ height: '585px' }} >
                ...
                {/* 圖片 */}
                <div style={{ width: '270px' }} className="rounded-set-3 overflow-hidden mb-3">
